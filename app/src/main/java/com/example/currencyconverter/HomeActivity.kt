...
//        binding.countryCodePickerFrom.setCustomMasterCountries("BD,US,IN")
    ...
    private fun totalExchangeRate(amount: Double?, fromString: String, toString: String) {
        ...
        var fromValue: Double? = getRateForCurrency(fromString, rates)
        var toValue: Double? = getRateForCurrency(toString, rates)
    ...
    fun getRateForCurrency(currency: String, rates: Rates): Double? = when (currency) {
